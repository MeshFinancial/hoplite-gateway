...
# Fix: use requests-based session fetch but with ALL cookies
old = '''        # Try to get session info from page JS context
        org_id = None
        user_id = None
        try:
...
new = '''        # Try to get session info via HTTP request with all cookies
        org_id = None
        user_id = None
        try:
